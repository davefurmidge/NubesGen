...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=northeurope&application=APP_SERVICE.free&runtime=DOTNET&database=NONE.free&addons=key_vault,storage_blob,application_insights,redis&gitops=true" | tar -xzvf -
```
